...
describe('MIP export recovery page states', () => {
  ...
  it('checks status on page show and exposes an explicit resume action', () => {
    ...
    expect(page).toContain('mipAdminModule.getPendingExportStatus()')
    expect(page).toContain('mipAdminModule.resumePendingExport')
    expect(page).toContain('mipAdminModule.clearPendingExport()')

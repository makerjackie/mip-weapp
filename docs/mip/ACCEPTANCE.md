...
开发用目录以及 6 个演示用户、3 个测试会员订单与权益、2 场 2030 活动、5 条报名、3 条机会、6 张合作卡和 3 条超级案例已通过 `pnpm seed:demo` 写入当前 AppID 的 MIP 表，均使用固定 ID 和版本化清单，没有修改非 MIP 表。Banner、公告、知识、消息、任务、游戏和异常复核等夹具仍在扩展，完成后再重跑当前 108 路由报告。

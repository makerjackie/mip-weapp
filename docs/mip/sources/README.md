...
| [Figma MIP Copy](https://www.figma.com/design/zo5RsWtzNWvhk6d5P53eCL/MIP--Copy-?node-id=69-4972) | 文件 `zo5RsWtzNWvhk6d5P53eCL`，入口节点 `69:4972` | 页面层级、布局、状态和视觉细节 | 节点映射见 [FIGMA_MAP.md](../FIGMA_MAP.md)；代表 frame 固定在 [figma-2026-08-25](../evidence/figma-2026-08-25)，同尺寸运行截图仍待验收 |

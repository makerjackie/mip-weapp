...
> 文档状态：历史执行计划。2026-08-28 接受的 [ADR 0004](../adr/0004-independent-web-admin.md) 已取代本文“暂不建设独立 Web”的决定。下文保留当时的计划、数量和措辞，不改写为当前事实；当前交付状态以 [PROJECT_STATUS.md](PROJECT_STATUS.md) 和 [ADMIN_WEB.md](ADMIN_WEB.md) 为准。

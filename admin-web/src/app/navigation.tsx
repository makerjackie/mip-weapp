...
export const adminNavigation: AdminNavigationItem[] = [
  ...
  { path: '/users', label: '用户管理', description: '查看用户、会员、分会和账号状态', group: '业务管理', icon: <UserOutlined />, capabilities: ['users.read'] },
  ...
  { path: '/permissions', label: '权限管理', description: '管理运营成员、角色策略和城市分会', group: '平台设置', icon: <SafetyCertificateOutlined />, capabilities: ['roles.change', 'branches.manage', 'audit.read'], requireAny: true },

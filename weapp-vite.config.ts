...
export default defineConfig({
  ...
  define: {
    __APP_NAME__: JSON.stringify(env.MINI_PROGRAM_NAME || '同行会'),
    __APP_NAMESPACE__: JSON.stringify(env.APP_NAMESPACE || 'membership'),
    ...
    __MEMBERSHIP_FUNCTION_NAME__: JSON.stringify(env.MEMBERSHIP_FUNCTION_NAME || 'membership-api'),
    __ADMIN_FUNCTION_NAME__: JSON.stringify(env.MEMBERSHIP_ADMIN_FUNCTION_NAME || 'membership-admin-api'),
    __PAY_FUNCTION_NAME__: JSON.stringify(env.MEMBERSHIP_PAY_FUNCTION_NAME || 'membership-cloudpay'),
    __PAYMENT_MODE__: JSON.stringify(env.MEMBERSHIP_PAYMENT_MODE || 'disabled'),
    __SUBSCRIBE_TEMPLATES_JSON__: JSON.stringify(env.MEMBERSHIP_SUBSCRIBE_TEMPLATES_JSON || ''),
  },
  weapp: {
    srcRoot: 'src',
    npm: {

...
assert(!/MIP_DB_CONNECTION_URI|MIP_LEDGER_SECRET|MIP_TEST_MEMBERSHIP_HMAC_SECRET|MIP_IDENTITY_PEPPER|MIP_MEDIA_SCOPE_SECRET|MIP_PHONE_ENCRYPTION_KEY|MIP_ADMIN_WEB_BFF_HMAC_SECRET/.test(clientSources), 'Server-only MIP configuration entered client source')

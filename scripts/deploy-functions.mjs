...
const secrets = Object.freeze({
  ...
  adminWebLoginQrHmac: stableSecretValues.MIP_ADMIN_WEB_LOGIN_QR_HMAC_SECRET,
...
function environmentForRole(role, options) {
  ...
  const extra = {
    ...
    admin: {
      ...
      MIP_ADMIN_WEB_LOGIN_QR_HMAC_SECRET: options.secrets.adminWebLoginQrHmac,
...
function verifyLocalOpenApiDeclarations() {
  const expected = {
    ...
    admin: ['security.msgSecCheck', 'wxacode.getUnlimited'],

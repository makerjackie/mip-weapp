...
export const RUNTIME_TABLE_PRIVILEGES = Object.freeze({
  ...
  mip_phone_sms_challenges: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_phone_sms_rate_limits: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  ...
  mip_event_types: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_event_tags: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_event_tag_assignments: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_event_video_recaps: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  ...
  mip_membership_chains: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_membership_adjustments: Object.freeze(['SELECT', 'INSERT']),
  ...
  mip_task_completions: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  ...
  mip_ai_draft_requests: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_membership_invitation_codes: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  ...
  mip_message_delivery_reviews: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  ...
  mip_task_submission_reviews: Object.freeze(['SELECT', 'INSERT']),
  mip_user_operation_logs: Object.freeze(['SELECT', 'INSERT']),
  mip_admin_accounts: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_entitlement_transactions: Object.freeze(['SELECT', 'INSERT']),
  mip_contribution_rules: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_contribution_transactions: Object.freeze(['SELECT', 'INSERT']),
  mip_contribution_reversals: Object.freeze(['SELECT', 'INSERT']),
  mip_videos: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_event_heart_history: Object.freeze(['SELECT', 'INSERT']),
  mip_business_cards: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_card_templates: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_card_history: Object.freeze(['SELECT', 'INSERT']),
  mip_event_drafts: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_opportunity_operation_logs: Object.freeze(['SELECT', 'INSERT']),
  mip_opportunity_delete_snapshots: Object.freeze(['SELECT', 'INSERT']),
  mip_opportunity_referral_records: Object.freeze(['SELECT', 'INSERT']),
  mip_exp_reversals: Object.freeze(['SELECT', 'INSERT']),
  mip_admin_login_records: Object.freeze(['SELECT', 'INSERT']),
  mip_admin_account_credentials: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
  mip_admin_roles: Object.freeze(['SELECT', 'INSERT', 'UPDATE']),
})

const RUNTIME_DELETE_TABLES = new Set([
  'mip_web_bff_requests',
  'mip_profile_tags',
  'mip_opportunity_roles',
  'mip_opportunity_tags',
  'mip_opportunity_locations',

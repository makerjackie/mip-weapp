export const mipOperationsConfig = {
  ...
  eventBanners: [
    {
      ...
      imagePath: '/assets/brand/mip-logo-yellow.png',
    ...
    },
    {
      ...
      imagePath: '/assets/brand/mip-logo-black.png',
  ...
  defaultCoverPaths: {
    event: '/assets/brand/mip-logo-yellow.png',
    opportunity: '/assets/brand/mip-logo-yellow.png',

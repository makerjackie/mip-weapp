...
const ACTIVATE_ACTION = 'activateKnowledgeIngestionSchedule'
const ACTIVATE_PROTOCOL = 'mip-knowledge-scheduler/activate/v1'
const ACTIVATE_DOMAIN = 'mip-knowledge-scheduler:activate:v1'
const TIMER_PROTOCOL = 'mip-knowledge-scheduler/timer/v1'
const TIMER_DOMAIN = 'mip-knowledge-scheduler:timer:v1'

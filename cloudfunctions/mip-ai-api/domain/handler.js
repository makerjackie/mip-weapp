...
const messages = {
  ...
  AI_DRAFT_REQUEST_EXPIRED: '本次草稿请求已过期，请重新提交',
  AI_DRAFT_REQUEST_IN_PROGRESS: '草稿正在生成，请稍后重试',
  AI_PROVIDER_RESPONSE_INVALID: 'AI 服务返回的草稿格式不正确',
  AI_PROVIDER_REJECTED: 'AI 草稿服务拒绝了本次请求',
  AI_PROVIDER_RESULT_UNKNOWN: 'AI 草稿结果暂未确认，请稍后重试',
  ...
  AI_AUDIO_UPLOAD_RESULT_UNKNOWN: '录音上传结果暂未确认，请稍后重试',
  ...
  IDEMPOTENCY_CONFLICT: '本次生成请求内容已变化，请重新提交',

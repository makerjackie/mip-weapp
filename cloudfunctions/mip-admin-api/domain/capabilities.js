...
const CAPABILITIES = Object.freeze({
  ...
  MEMBERSHIPS_ADJUST: 'memberships.adjust',
  ...
  EVENTS_COMMENTS_MANAGE: 'events.comments.manage',
  EVENTS_CATALOG_MANAGE: 'events.catalog.manage',
  EVENTS_RECAPS_MANAGE: 'events.recaps.manage',
  ANNOUNCEMENTS_MANAGE: 'announcements.manage',
  MESSAGES_MANAGE: 'messages.manage',
  MESSAGES_DELIVERY_REVIEW: 'messages.delivery.review',
  COMMUNICATIONS_PUBLISH: 'communications.publish',
  COMMUNITY_REPORTS_MANAGE: 'community.reports.manage',
  USER_CONTENT_MODERATE: 'userContent.moderate',
...
const roleCapabilities = Object.freeze({
  ...
  PLATFORM_OPERATIONS: [
    ...
    CAPABILITIES.MEMBERSHIPS_READ,
    CAPABILITIES.MEMBERSHIPS_ADJUST,
    ...
    CAPABILITIES.EVENTS_CATALOG_MANAGE,
    CAPABILITIES.EVENTS_RECAPS_MANAGE,
    ...
    CAPABILITIES.BANNERS_MANAGE,
    CAPABILITIES.BADGES_MANAGE,
    CAPABILITIES.GAME_MANAGE,
